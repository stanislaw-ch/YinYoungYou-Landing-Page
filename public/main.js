...
if (surveyForm) {
  ...
  var send = function send(data) {
    ...
    var json = Object.assign.apply(Object, _toConsumableArray(Array.from(formEntries, function (_ref) {
    ...
    fetch("/send-survey", fetchData).then(function (res) {
      console.log(res);

      if (res.ok) {
        successMassage.classList.remove("survey__form-success--hidden");
      } else {
        var errorMessage = data.querySelector(".form__message--error");
...
var Validator = /*#__PURE__*/function () {
  ...
  _createClass(Validator, [{
    ...
    key: "send",
    value: function send(formType) {
      var _this3 = this;

      var successMessageOnButton = this.form.querySelector(".form__button");
      var successMessage = this.form.querySelector(".form__message--success");
      var errorMessage = this.form.querySelector(".form__message--error");
      var formEntries = new FormData(this.form).entries();
      var json = Object.assign.apply(Object, _toConsumableArray(Array.from(formEntries, function (_ref) {
        var _ref2 = _slicedToArray(_ref, 2),
            x = _ref2[0],
            y = _ref2[1];
      ...
      if (formType === "subscribe") {
        fetch("/subscribe", fetchData).then(function (res) {
          if (res.ok) {
      ...
      if (formType === "contact") {
        fetch("/send-form", fetchData).then(function (res) {
          if (res.ok) {
            successMessageOnButton.classList.add("form__button--success");
            successMessageOnButton.innerText = "Vielen Dank f\xFCr deine Nachricht!";
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("de296b11b772390255dc")
/******/ 	})();
/******/ 	
